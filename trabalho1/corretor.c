...
//  ----- Orientaùùes gerais -----
//  Descriùùo: esse arquivo contùm exemplos de testes das questùes do trabalho.
//  o aluno pode incrementar os testes

//  Copyright ù 2016 Renato Novais. All rights reserved.
// ùltima atualizaùùo: 19/08/2016 - 12/12/2018
...
void testSomar();    //funùùo utilizada para testes
void testFatorial(); //funùùo utilizada para testes
void testQ1();
void testQ2();
void testQ3();
void testQ4();
...
void testQ4()
{
    ...
    strcpy(strTexto, "Laboratorio de programacao: para ratos de programaùùo");
    ...
    strcpy(strTexto, "Olù, o mundo ù muito grande. Tem muitas pessoas, e muitos problemas");
    strcpy(strBusca, "mui");
